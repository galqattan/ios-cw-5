...
class ViewController: UIViewController {
    ...
    @IBAction func tap(_ sender: UIButton) {
        ...
        if checkWinner(p: "X"){
            okAlert(title: "YAAYYYYY X Wins🥳🥳🥳🎉🎉🎉", message: "You just won! Now reset the game to beat the rest of your teammates🥳🎉!!")
        }
        else if checkWinner(p: "O"){
            okAlert(title: "YAAYYYYY O Wins🥳🥳🥳🎉🎉🎉", message: "You just won! Now reset the game to beat the rest of your teammates🥳🎉!!")
        }
        else if turn == 8{
            okAlert(title: "It's a draw, no one won😕😕", message: "Better luck next time, reset the game to get another chance😃!")
        }
    }
